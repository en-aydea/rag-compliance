...
1.  **Segmenting** the call to find relevant "Query/Response" pairs.
2.  **Transforming** the conversational query into a formal, keyword-rich search query.
3.  **Retrieving** the *correct* legal text from a vector database using the transformed query.
4.  **Analyzing** the agent's response against the retrieved legal context to find violations or omissions.
